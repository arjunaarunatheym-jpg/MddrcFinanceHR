...
import { LogOut, Calendar, ClipboardCheck, Users, FileText, ChevronDown, ChevronRight, MessageSquare, Search, Eye, Building2, BookOpen, DollarSign } from "lucide-react";
                  ...
                  (() => {
                    ...
                    return (
                      <div className="space-y-6">
                        ...
                        {/* Coordinator Fee Records (if applicable) */}
                        {hasCoordinatorRole && coordinatorIncomeData && coordinatorIncomeData.records?.length > 0 && (
                          <div>
                        ...
                        {/* Marketing Commission Records (if applicable) */}
